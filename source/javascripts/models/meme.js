...
MEME.MemeModel = Backbone.Model.extend({
  defaults: {
    ...
    TextSize: 24,
    TextSizeOpts: [14, 24, 36],
    fontColorOpts: ['#fff', '#000'],
    headlineText: 'Skriv din text!',
    MainText: '',
    height: 378,
    width: 755,
    imageScale: 1,
    ...
    backgroundColorOpts: ['#007632','#ED8522', '#F4E007','#E0584E','#000','#FAD0D1', '#9BB6D4','#53AFAE', '#DECCBE', '#AF64A9'],
    overlayColor: '#000',
    overlayColorOpts: ['#007632','#ED8522', '#F4E007','#E0584E','#000','#FAD0D1', '#9BB6D4','#53AFAE', '#DECCBE', '#AF64A9'],
    paddingRatio: 0.05,
    textAlign: 'left',
