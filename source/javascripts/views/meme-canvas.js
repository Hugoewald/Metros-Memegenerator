...
MEME.MemeCanvasView = Backbone.View.extend({
  ...
  render: function() {
    ...
    function renderText(ctx) {
      ...
      ctx.font = d.TextSize +'pt '+ d.fontFamily;
      ctx.fillStyle = d.fontColor;
    ...
    function renderWatermark(ctx) {
      ...
      if (bh && bw) {
        ...
        ctx.drawImage(m.watermark, 0, 0, bw, bh, d.width-padding-tw, d.height-padding-th + 72, 1272, th);
        ctx.globalAlpha = 1;
      }
    }
